set -ex
python train.py --dataroot None --name egan_cifar10_1 \
       ...
       --no_dropout --no_flip \
       --D_iters 1 \
       --use_pytorch_scores --score_name IS FID --evaluation_size 50000 --fid_batch_size 500 --fid_stat_file ./TTUR/stats/fid_stats_cifar10_train.npz \
